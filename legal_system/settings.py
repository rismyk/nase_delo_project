...
# from decouple import config - пока уберем
...
DATABASES = {
    'default': {
        ...
        'USER': 'romansmyk',  # ваше имя пользователя Mac
        'PASSWORD': '',
        'HOST': 'localhost',
        'PORT': '5432',
    }
...
# Email settings (для локальной разработки)
EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'

# Session settings
SESSION_COOKIE_AGE = 48 * 60 * 60  # 48 часов
